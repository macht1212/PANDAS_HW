...
Выпадение комбинаций с *77 -> 9/1000 (так как один из вариантов присутствует в 777) 
и *00 -> 10/1000
...
всех вышеперечисленных событий, а именно 0.204, то есть всего 20.4%


## Итог
Используя формулу расчета среднего значения получаем:  
Х = (200 + 100 + 50 + 15 + 10)х0.001 + 5x0.009 + 2x0.01 + (3+1)x0.09 = 0.8 у.е. 
...
Получается что ожилаемый выигрыш составит 0.8 - 0.899 = (0.099) у.е.  
